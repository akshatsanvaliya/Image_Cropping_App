...
public class FrameFragment extends BottomSheetDialogFragment implements  FrameAdapter.FrameAdapterListner {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View iteView=  inflater.inflate(R.layout.fragment_frame, container, false);
        recycler_frame = (RecyclerView) iteView.findViewById(R.id.recycler_frame);
        btn_add_frame = (Button) iteView.findViewById(R.id.btn_add_frame);
